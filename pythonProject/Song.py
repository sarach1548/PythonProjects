...
class Song(Singer):
    def __init__(self, nameSong, nameSinger):
        super().__init__(nameSinger)
        self.nameSong = nameSong
        self.routing = f"D:/פייתון/pythonProject2/pytonM/{nameSong}.mp3"

    def add_song(self):
        """add routing song to routing file of song"""
        routing_file = open("D:/פייתון/pythonProject2/SongList.txt", 'r+', encoding='utf-8')
